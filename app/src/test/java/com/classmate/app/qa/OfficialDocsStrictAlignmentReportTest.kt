...
class OfficialDocsStrictAlignmentReportTest {
    ...
    fun strictAlignmentReportRecordsQwenDeepThinkingAndConservativeSmokeRules() {
        ...
        assertTrue(report.contains("FAST=false"))
        assertTrue(report.contains("BALANCED=false"))
        assertTrue(report.contains("DEEP_STUDY=true"))
        assertTrue(report.contains("profile-aware"))
        assertTrue(report.contains("reasoning_effort"))
        assertTrue(report.contains("reasoning_effort=low"))
        assertTrue(report.contains("reasoning_effort=medium"))
        assertTrue(report.contains("reasoning_effort=high"))
        assertTrue(report.contains("never send raw `max`"))
