...
/**
 * The competition demo build must report version 1.14.13 / 126, not older release lines. The build commit is
...
class AppVersionTest {
    ...
    fun versionNameIsCurrentAndNotOld() {
        assertTrue(gradle.contains("versionName = \"1.14.13\""))
    ...
    fun versionCodeIsCurrent() {
        assertTrue(gradle.contains("versionCode = 126"))
    }
