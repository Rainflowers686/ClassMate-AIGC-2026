...
object MultimodalImportCatalog {
    val entries: List<MultimodalImportEntry> = listOf(
        ...
        MultimodalImportEntry(
            ...
            title = "本地音频",
            status = "下一阶段 ASR",
            detail = "当前不解析音频、不上传文件；后续接入 ASR 后可转为课堂转写。",
            availableNow = false,
            opensPicker = true,
        ...
        MultimodalImportEntry(
            ...
            title = "PPT / 课件图片",
            status = "手动 OCR 已可演示",
            detail = "当前未接入真实 OCR；可先记录文件元数据并粘贴 OCR 识别文字，后续接入 vivo OCR。",
            availableNow = true,
            opensPicker = true,
        ...
        MultimodalImportEntry(
            ...
            title = "板书照片",
            status = "手动 OCR 已可演示",
            detail = "当前不识别板书照片、不上传图片；可粘贴 OCR 文字并作为板书 OCR 证据来源。",
            availableNow = true,
            opensPicker = true,
        ...
        MultimodalImportEntry(
            ...
            title = "PDF / 讲义截图",
            status = "手动 OCR 已可演示",
            detail = "当前不解析 PDF 或截图；可粘贴讲义 OCR 文本，后续接入 vivo OCR。",
            availableNow = true,
            opensPicker = true,
