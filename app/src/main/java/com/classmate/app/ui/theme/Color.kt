...
private fun focusImmersionScheme(accent: AccentColorPreset): ClassMateColorScheme {
    ...
    return ClassMateColorScheme(
        ...
        surfaceVariant = Color(0xFF303C46),
        surfaceContainerLow = Color(0xFF1A2027),
        surfaceContainerHigh = Color(0xFF26313A),
        primary = resolvedAccent,
        primaryContainer = blend(resolvedAccent, Color(0xFF151A1F), 0.26f),
        secondary = Color(0xFFC8C6C5),
        secondaryContainer = Color(0xFF37424C),
        tertiary = Color(0xFF00DBE9),
        textPrimary = Color(0xFFE2E2E2),
        textSecondary = Color(0xFFC5CED6),
        border = Color(0xFF71808A),
        outline = Color(0xFF394650),
        success = Color(0xFF00DBE9),
        warning = accent.resolveFor(ThemePreset.FOCUS_IMMERSION, dark = true),
        error = Color(0xFFFFB4AB),
        info = Color(0xFF00DBE9),
        focusSurface = Color(0xFF1B232B),
        evidenceSurface = Color(0xFF222C34),
        accent = resolvedAccent,
        isDark = true,
    )
}
